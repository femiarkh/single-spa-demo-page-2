...
const url = `https://single-spa-demo-femiarkh.s3.eu-west-1.amazonaws.com/%40femiarks/page-2/${process.env.TRAVIS_COMMIT}/femiarks-single-spa-demo-page-2.js`;
  ...
  .get(url, (res) => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        res.headers["content-type"].toLocaleLowerCase().trim() ===
          "application/javascript"
      ) {
        const moduleName = `@femiarks/single-spa-demo-page-2`;
